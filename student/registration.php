...
<section>
    <div class="reg_img">
            ...
            <div class="box2">
                ...
                <div class="login">
                    ...
                    <br>
                    <input class="form-control" type="text" name="roll" placeholder="RollNo" required=""> 
                    <br>
                    <input class="form-control" type="text" name="email" placeholder="Email" required=""> 
                    <br>
                    <input class="form-control" type="text" name="contact" placeholder="Phone No" required=""> 
                    <br>
                    <input class="btn btn-default" type="submit" name="submit" value="Sing Up"
                    style="background-color: aliceblue; color: black; width: 90px; height: 30px;"> 
                </div>
                </form>
    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        if($count==0)
        {
          mysqli_query($db,"INSERT INTO `STUDENT` VALUES('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[contact]', 'pic.png');");
        ?>
